...
Nous calculons ensuite l'expected shortfall à un niveau de risque correspondant à une value at risk de 99,5% sur l'historique de données de rendements annualisés. Nous ajoutons 7,5% à la value at risk pour inclure l'ajustment symétrique ordonné par l'EIOPA dans le "Calibratiion Paper".
