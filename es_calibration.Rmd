...
# Mesures de risques pour la calibration des chocs solvabilité II.
...
Par définition la value at risque n'est pas sous-additive, ainsi nous introduisons qui une nouvelle mesure de risque cohérente, l'expected shortfall qui peut se définir comme "l'espérance des pertes au delà de la value at risque". 
Ainsi soit $ES_\alpha$ l'expected shortfall de niveau $\alpha$:

$$ ES_\alpha(X) = \frac{1}{1-\alpha}\int_{\alpha}^{1} VaR_\tau (X)d\tau $$

# Calcul du Capital de solvabilité requis (SCR) sous solvabilité II.
