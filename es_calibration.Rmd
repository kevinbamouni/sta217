...
```{r, echo = FALSE, fig.align = 'center', message=FALSE, fig.cap= " Distribution empirique des rendement de l'indice MSCI"}
...
5.Base de données de l'indice MSCI World : https://www.msci.com/developed-markets
